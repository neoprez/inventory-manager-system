...
CREATE TABLE supermarket_employees (
...
CREATE TABLE supermarket_product_stock (
	product_upc INT(12),
...
CREATE TABLE product_purchased_in_order (
	order_id BIGINT(20),
	product_up INT(12),
	number_of_items_purchased INT(5)	
);

CREATE TABLE product_threshold_notifications (
...
CREATE TABLE sent_product_notifications (
